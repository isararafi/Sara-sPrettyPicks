...
//    }
    ...
    if (role.equals("admin")) {
        signupSuccess = db.signupAdmin( email,password,username); // Call the admin signup method
    } else {
        signupSuccess = db.signupCustomer(username, email, password); // Call the customer signup method
    }
